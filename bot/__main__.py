...
def start(update, context):
    ...
    buttons.buildbutton("MAIN CHANNEL", "https://t.me/Beta_Bot_Updates")
    buttons.buildbutton("Report Group", "https://t.me/BETA_BOTSUPPORT")
    buttons.buildbutton("Mirror Group", "https://t.me/MirrorLeechBeta")
    buttons.buildbutton("Owner", "https://t.me/TG_BI_CH")
    
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Welcome | BETA Mirror service is ready for you
